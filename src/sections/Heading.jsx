  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center mt-20">
        <h1 className="font-[1000] text-9xl mb-20 animate-in slide-in-from-top duration-1000    ">
          Work-in{" "}
        ...
        <div className="flex w-full items-center ">
          <div className="flex-1 text-7xl font-semibold  ">
            <TypeAnimation
              sequence={[1000, "Web Developer based in Philippines"]}
              speed={20}
              repeat={1}
              cursor={false}
            />
            <a
              href="#about"
              className="text-xl block  mt-10 animate-pulse   w-32 rounded-2xl p-3  "
            >
              <TypeAnimation
                sequence={[5000, "Show more"]}
                speed={5}
                repeat={1}
                cursor={false}
              />
          ...
          <div className="flex-1 pl-40  relative animate-in fade-in-30 duration-500">
            <SlideShow imageInbox={images} autoslideTimer={2000} />
          </div>
        </div>
      </div>
    </div>
